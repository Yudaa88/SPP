    ...
    <div class="layout-wrapper layout-content-navbar">
      <div class="layout-container">
        ...
        <aside id="layout-menu" class="layout-menu menu-vertical menu bg-menu-theme">
          <div class="app-brand demo mt-0" style="background-color: #111311">
            <a href="index.html" class="app-brand-link">
                <img src="{{ asset('storage/images/smk.png') }}" alt="Nama Instansi" class=" img-fluid navbar-logo d-flex justify-content-center" width="50">
                  <defs>
                    <path
              ...
              <span class="app-brand-text menu-text fw-bolder ms-2 text-white">SMK Harapan Bangsa </span>
            </a>
          ...
          <ul class="menu-inner py-1" style="background-color: #111311">
            <!-- Dashboard -->
