...
<html>
	<head>
		...
		<style>
			...
			.letterhead img {
				max-width: 100px; /* Max width of logo */
				margin-bottom: 10px;
			}
	...
	<body>
		<div class="invoice-box">
			...
			<div class="letterhead">
				<img src="{{ asset('storage/images/smk.png') }}" alt="Logo Perusahaan" />
				<h2>Smk Harapan Bangsa</h2>
				<p>
					Alamat <br />
					Jl. Gelatik Pasir Putih Rt16, Kota Jambi<br />
					Telepon: 0741570591<br />
					Email: smkharapanbangsa07@gmail.com
				</p>
				<hr>
			</div>
